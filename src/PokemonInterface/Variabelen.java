...
public class Variabelen {
    ...
    //type;/*""*/ // Used in Pokemon // // Removed type from Pokemon because in the main it does not fill a type-argument
    // Added type again because its used a a method in PokemonGymImpl
